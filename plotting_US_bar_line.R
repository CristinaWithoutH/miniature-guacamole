...
american_data <- read_csv("american_yearly_genres_absolute.csv")
...
US_period_relative <- american_data |>
  ...
  pivot_longer(c("fantasy", "poetry", "science_fiction", "romance"), names_to = "genre", values_to = "absolute_frequency")|>
