...
# Pivot longer
relative_pivoted <- pivot_longer(relative_data, c("fantasy", "science_fiction", "poetry", "satire", "observational_comedy", "non_fiction", "romance_novel"), names_to = "genre")
absolute_pivoted <- pivot_longer(absolute_data, c("fantasy", "science_fiction", "poetry", "satire", "observational_comedy", "non_fiction", "romance_novel"), names_to = "genre")

# Visualization: line plot for relative occurrence - smooth lines per gen.
