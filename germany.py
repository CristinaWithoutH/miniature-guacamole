...
for letter in letters:
    with open(f'data\{letter}_people.json') as file:
        ...
        for person in persons:     
            ...
            is_german = False
            if "ontology/nationality" == "German" or "ontology/nationality" == "Germany" or "ontology/nationality_label" == "German" or "ontology/nationality_label" == "Germany" in person: 
                is_german = True
